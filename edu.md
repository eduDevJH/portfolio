...
* 사용 교재 - 모두의 스크래치, 딱! 한권으로 끝내는 코딩 자격증 cos 2급 스크래치, 코딩 1급 시험대비서 : 스크래치, 알고리즘 이해와 창의개발 프로그래밍
            - 학원 자체 교재 (MP-A1, A2, DS 101, 102, 103)  
...
* 사용 교재 - 학원 자체교재(MP-M1, M2, DC 201, 202, DC-AI)
...
### 1. C 
* C언어의 기본 문법을 이해하고 프로그래밍의 전반적인 이해를 돕는 수업을 진행했습니다.  
...
* 사용 교재 - 점프 투 파이썬, 학원 자체 교재(CD-P1, CD-P2, PY-C1, C2, M1), 이것이 취업을 위한 코딩 테스트다 with 파이썬, 파이썬 코딩 도장  
...
> * 참가한 학생들은 파이널리스트로 대회를 마무리했습니다.(팀 독도)
...
### 5. 사고력 올림피아드   
> * 중학생들을 대상으로 특강 수업을 진행했습니다.  
> * 중학생 사고력 올림피아드는 초등부와는 다른점이 있어 관련된 내용을 중심으로 강의를 했고 학생들이 글을 최대한 많이 쓸 수 있도록 과제도 제공했습니다.  
> * 특강을 듣는 모든 학생들의 글을 첨삭해줬고 학생들의 강점에 맞는 글쓰기를 알려줬습니다. 결과는 중등부 2명 장려상으로 마무리했습니다.  

<br>

### 6. 영재 교육원 (가천대, 아주대, 서울여대)
> * 2021년 가천대 브릿지 과정을 진행하는 초등 4학년 학생 2명이 각자 준비하는 프로젝트에 맞춰 작품 가이드를 안내했습니다.
> * 가천대 합격생 1명은 아두이노만 이용하여 과제를 제출했고, 다른 1명은 아두이노와 앱인벤터를 이용하여 과제를 만들었습니다.  
> * 2021년 아주대 정보 영재 합격은 6학년 학생으로 면접 질문에서 파이썬으로 답변을 진행하고 과제도 수행했습니다.  
> * 가천대 2명과 아주대 1명 모두 합격했습니다.
> * 2022년에는 2023년 서울여대 영재원 중등부 기초과정 최종 합격과 심화과정 최종 면접까진 지도했습니다.

<br>

### 7. 고등학교 입시 (디미고, 단대소고, 경기과고)
> * 2019년에 디미고 준비하는 학생을 위해 특별 전형과 일반 전형 준비를 모두 진행했었습니다.
> * 2021년에 단대부속 소프트웨어 고등학교(단대소고)에 지원하기 위해 여러 입시 전략과 포트폴리오 준비로 유니티를 이용했고 소프트웨어 특기자 전형으로 합격했습니다.

> * 2022년 단대소고 AI과를 지원하는 학생을 위해 포트폴리오 제작과 면접 전략을 지도했었고 학교에 소프트웨어 특기자 전형으로 합격했습니다.
> * 2022년 경기과학고등학교 입시를 준비하는 학생으로 1차 자소서에 코딩과 관련된 내용을 적어 연구과제로 제출했습니다.  
>   - 3차 면접 대비를 위해 작성한 자소서에 맞는 프로젝트는 직접 개발하게 하고 해당 내용에서 나올만한 면접 대비 질문을 잡아줬습니다.
> * 2023년에는 선린고 해킹방어과에 학생을 합격시켰습니다. 내신과 출석이 약한 학생이라 전략을 세워 특별전형으로 입학시켰습니다.
<br>

### 8. 청소년 IT 올림피아드 (디미고)
> * 2021년에 진행된 청소년 IT 올림피아드에서 중학교 1학년 학생이 창업부분을 웹과 관련된 아이템을 만들어 본선까지 진출했습니다.  
> * 면접까지 대비로 작성된 대본을 첨삭해주고 학생이 발표에서 실수를 자주하는 부분을 고치는 연습을 진행했습니다. 결과는 동상으로 마쳤습니다.  
> * 2022년에 진행된 청소년 IT 올림피아드에서는 다양한 분야에 학생들을 참가시켰습니다.  
> * 2022년 창업 부분 본선 진출, 알고리즘 부분 본선 진출, 해킹방어 부분 동상으로 대회를 마무리했습니다.  

### 9. 메타버스 경진대회
> * 2023년에는 메타버스 계약 시스템으로 장려상 1팀, VR 재난 상황 교육 프로그램으로 우수상 1팀으로 대회를 마무리했습니다
